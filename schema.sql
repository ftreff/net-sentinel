...
CREATE TABLE IF NOT EXISTS ip_events (
    ...
    port INTEGER,
    service TEXT,
    timestamp TEXT NOT NULL,  -- stored as ISO 8601 UTC string
    city TEXT,
    state TEXT,
    country TEXT,
    country_code TEXT,
    ...
    UNIQUE(ip, port, verdict, direction)  -- enforce deduplication at schema level
);

-- Indexes for query performance
CREATE INDEX IF NOT EXISTS idx_ip ON ip_events(ip);
